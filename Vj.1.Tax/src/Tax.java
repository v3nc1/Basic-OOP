...
public class Tax {
	...
	public Tax(double grossIncom, int dependents) {
		
		this(grossIncom, "NY", dependents);
		
	}
	
	public static void convertToEuros(double taxInDolars) {
		
		System.out.println("Tax in Euros: "+ taxInDolars/1.25);
